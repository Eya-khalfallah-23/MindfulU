...
class MhFirebaseException implements Exception {
  /// The error code associated withe the exception
  final String code;

  /// Constructor that takes an error code
  MhFirebaseException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'captcha-check-failed':
        return 'The re-Captcha response is invalid. Please try again.';
      ...
      case 'invalid-sender':
        return 'The email template sender  is invalid. Please verify.';
